...
center = HSV[1300:1700, 1000:1400]
...
lower_center = np.array([np.median(center[:,:,0])-5,105,110])
upper_center = np.array([np.median(center[:,:,0])+5,255,255])
...
cv2.imwrite("testbl# -*- coding: utf-8 -*-
"""
Created on Tue Jul 18 20:07:59 2017
